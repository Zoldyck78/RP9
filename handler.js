                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            this.sendFile(id, pp, `https://some-random-api.ml/welcome/img/7/stars?key=4SKDlB5Eg9dhouWKOdXCEeDiYWJ8hQolHQDnZnUvPPdRM6tskQ2xWHk73wkim7uZ&username=${user.split('@')[0]}&discriminator=0001&avatar=${pp}%3Fsize=512&type=join&guildName=${this.getName(id))}&textcolor=white&memberCount=100`, text, null, false, {
                                contextInfo: {
                                    mentionedJid: [user]
                                }
                            })
